...
describe("PlaceOrderUsecase unit test", () => {
  // Arrange: Preparar o cenário / configurar os dados e dependências necessários
  // Act: Executar a ação/atividade que está sendo testada
  // Assert: Verificar se o resultado está conforme o esperado
  
  describe("validatedProducts method", () => {
  ...
  describe("getProduct method", () => {
    ...
    it("should throw an error when product not found", async () => {
      // antes de recuperar o produto, preciso verificar se ele existe
  ...
  describe("execute method", () => {
    ...
    it("should throw an error when products are not valid", async () => {
      ...
      const mockValidationProducts = jest
      ...
      expect(mockValidationProducts).toHaveBeenCalledTimes(1)
    })
